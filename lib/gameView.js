(function(){
  ...
  GameView.prototype.bindStartListener = function () {
    this.startListener = this.beginAnimationCycle.bind(this);
  ...
  GameView.prototype.drawSplashPage = function () {
    ...
    splash.onload = function () {
      ctx.drawImage(splash, 0, 0, Asteroids.Game.DIM_X, Asteroids.Game.DIM_Y);
    };
  };

  GameView.prototype.beginAnimationCycle = function () {
