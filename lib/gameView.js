(function(){
  ...
  GameView.prototype.getRank = function () {
    ...
    if (between(0, 1500)) {
      rank = "ASTRO-NOT";
    } else if (between (1501, 3000)) {
      rank = "SPACE GHOST";
    } else if (between (3001, 5000)) {
      rank = "SPACE CADET";
    } else if (between (5001, 7000)) {
      rank = "SHARPSHOOTER";
    } else if (between (7001, 9000)) {
      rank = "SPACE INVADER";
    } else if (between (9001, 11000)) {
      rank = "SPACE COWBOY";
    } else if (between (11001, 30000)) {
      rank = "SPACE PIRATE";
