(function(){
  ...
  GameView.prototype.handleButton = function (e) {
    ...
    var x = pos[0], y = pos[1];
    var soundButton = this.soundButtonSelected(x, y);
    if (soundButton) this.soundsSelected = true;
    if (soundButton || this.noSoundSelected(x, y)) this.beginGame();
  };
  ...
  GameView.prototype.noSoundSelected = function (x, y) {
    return Asteroids.Util.between(x, 450, 780) &&
